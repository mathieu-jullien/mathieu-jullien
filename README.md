# Hello 👋
### 👤 Moi c'est Mathieu, je suis développeur back-end depuis +9ans spécialisé sous PHP / Symfony et lead développeur depuis +5ans. Mais j'ai aussi d'autres compétences en front-end (Angular) et en DevOps (Docker, Kubernetes, CI/CD).
...
🟠​ En poste chez Koala Interactive
...
MacOS | Windows / WSL | Docker | VS Code | IA Claude Code
